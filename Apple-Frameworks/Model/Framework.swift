...
struct MockData {
    ...
    static let frameworks = [
        Framework(name: "App Clips",
                  ...
                  description: "App Clips are a great way for users to quickly access and experience what your app has to offer. An App Clip is a small part of your app thatâs discoverable at the moment itâs needed. App Clips are fast and lightweight so a user can open them quickly.\n\nWhether they're ordering take-out from a restaurant, renting a scooter, or setting up a new connected appliance for the first time, users will be able to start and finish an experience from your app in seconds. And when theyâre done, you can offer the opportunity to download your full app from the App Store."),
        ...
        Framework(name: "CloudKit",
                  ...
                  description: "Store your appâs data in iCloud and keep everything up to date across apps and on the web with CloudKit JS. With up to 1PB of free storage for each app, itâs never been easier to build and grow your apps using CloudKit."),
        ...
        Framework(name: "SiriKit",
                  ...
                  description: "Siri is the worldâs most popular intelligent assistant, and now has an all new compact design. With SiriKit and Shortcuts, your apps can help users get things done with just their voice, intelligent suggestions, or the Shortcuts app.\n\nYour apps can now also integrate with more platforms with Shortcuts on watchOS 7, SiriKit Music on HomePod, and SiriKit Media on Apple TV."),
